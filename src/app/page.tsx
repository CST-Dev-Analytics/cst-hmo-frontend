...
import { FaUser, FaLock, FaEnvelope, FaHospital, FaUserMd, FaIdCard } from 'react-icons/fa';
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className={`pl-10 w-full px-4 py-2 rounded-lg border ${errors.employeeId ? 'border-red-500' : 'border-gray-300'} focus:outline-none focus:ring-2 focus:ring-blue-500`}
